...
carcloudApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
carcloudApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
carcloudApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
...
carcloudApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
carcloudApp.controller('AuditsController', function ($scope, $filter, AuditsService) {
